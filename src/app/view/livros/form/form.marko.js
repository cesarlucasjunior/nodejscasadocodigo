...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/app/view/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\"></div><div><label for=\"capa\">Capa:</label><input type=\"file\" id=\"capa\" name=\"capa\" placeholder=\"imagem de capa\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"150.25\" value=\"" +
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/app/view/livros/form/form.marko",
    tags: [
